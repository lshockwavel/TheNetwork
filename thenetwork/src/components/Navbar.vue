  ...
  <nav class="navbar navbar-expand-md bg-codeworks border-bottom border-vue">
    <div class="container gap-2">
      <RouterLink :to="{ name: 'Home' }" class="d-flex align-items-center text-light">
        ...
        <!-- <i class="mdi mdi-account-network navbar-brand" height="45"></i> -->
        <b class="fs-5">The GregNet</b>
      </RouterLink>
      <!-- collapse button -->
      ...
      <div class="collapse navbar-collapse " id="navbar-links">
        <ul class="navbar-nav">
          <li v-if="account">
            <RouterLink :to="{ name: 'Profile', params: { profileId: account?.id } }" class="btn text-green selectable">
              Your Posts
            </RouterLink>
          </li>
          <li v-if="account">
